...
Nt=1600; % max number of time iterations
dt_out=20; % output files every "dt_out" iterations
...
% LAGRANGIAN MARKERS %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Mquad=10; % number of markers in the smallest quadrant
Mquad_crit=5; % minimum number of markers allowed in smallest quadrant (for reseeding)
...
BC.left=[1 0 (-3.1688e-10)*1.4/2];
BC.right=[1 0 (3.1688e-10)*1.4/2];
